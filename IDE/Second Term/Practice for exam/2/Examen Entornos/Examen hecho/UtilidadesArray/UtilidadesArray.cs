    ...
    public class UtilidadesArray
    {
        public int[] OrdenarArray(int[] array)
        {
            ...
            /* 
                ...
                * un indiceActual + 1 y si fuéramos hasta el final, intentaríamos 
                * acceder a un valor fuera de los límites del arreglo 
            */
        ...
        public int BuscarElementoArray(int[] array, int numBuscado)
        {
            ComprobarArray(array);
        ...
        private void ComprobarArray(int[] array)
        {
            if (array == null)
            {
